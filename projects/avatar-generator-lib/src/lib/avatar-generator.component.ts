...
export class AvatarGeneratorComponent implements OnInit {
  ...
  public getRandomEyebrowType(): void {
    this.eyebrowType = this.getRandomStyle(
      this.eyebrowTypesArray,
      EyebrowTypes
    );
  }
  ...
  public getRandomFacialHairType(): void {
    this.facialHairType = this.getRandomStyle(
      this.facialHairTypesArray,
      FacialHairTypes
    );
  }

  public getRandomGlassesType(): void {
    this.glassesType = this.getRandomStyle(
      this.glassesTypesArray,
      GlassesTypes
    );
  }
  ...
  public getRandomClothingGraphic(): void {
    this.clothingGraphic = this.getRandomStyle(
      this.clothingGraphicTypesArray,
      ClothingGraphicTypes
    );
  }
  ...
  //iterate over hair options
  public iterateOverHairTypes(upwards: boolean): void {
    this.hairType = this.iterateOverOptions(
      this.hairType,
      this.hairTypesArray,
      HairTypes,
      upwards
  ...
  public iterateOverEyebrowTypes(upwards: boolean): void {
    this.eyebrowType = this.iterateOverOptions(
      this.eyebrowType,
      this.eyebrowTypesArray,
      EyebrowTypes,
      upwards
  ...
  public iterateOverEyeTypes(upwards: boolean): void {
    this.eyeType = this.iterateOverOptions(
      this.eyeType,
      this.eyeTypesArray,
      EyeTypes,
      upwards
  ...
  public iterateOverNoseTypes(upwards: boolean): void {
    this.noseType = this.iterateOverOptions(
      this.noseType,
      this.noseTypesArray,
      NoseTypes,
      upwards
  ...
  public iterateOverMouthTypes(upwards: boolean): void {
    this.mouthType = this.iterateOverOptions(
      this.mouthType,
      this.mouthTypesArray,
      MouthTypes,
      upwards
    );
  }
  ...
  public iterateOverFacialHairTypes(upwards: boolean): void {
    this.facialHairType = this.iterateOverOptions(
      this.facialHairType,
      this.facialHairTypesArray,
      FacialHairTypes,
      upwards
  ...
  public iterateOverGlassesTypes(upwards: boolean): void {
    this.glassesType = this.iterateOverOptions(
      this.glassesType,
      this.glassesTypesArray,
      GlassesTypes,
      upwards
  ...
  public iterateOverClothingTypes(upwards: boolean): void {
    this.clothing = this.iterateOverOptions(
      this.clothing,
      this.clothingTypesArray,
      ClothingTypes,
      upwards
    );
  }
  ...
  public iterateOverClothingGraphicTypes(upwards: boolean): void {
    this.clothingGraphic = this.iterateOverOptions(
  ...
  private getRandomStyle(
    ...
    enumm:
      | typeof HairTypes
      | typeof ClothingTypes
      | typeof ClothingGraphicTypes
      | typeof EyebrowTypes
      | typeof EyeTypes
      | typeof NoseTypes
      | typeof MouthTypes
      | typeof FacialHairTypes
      | typeof GlassesTypes
  ...
  public doDownload(format: string): void {
    if (format === 'png') {
      svg.saveSvgAsPng(
        this.avatar?.nativeElement?.querySelector('svg'),
        'avatar.png'
      );
    } else {
  ...
  public manageDisplayHeader(header: string) {
    if (header === this.skin) {
      this.desactivateAllHeader();
      document.querySelector(`#${this.skin}-header`).classList.add('isActive');
      this.displaySkin = true;
    } else if (header === this.hair) {
      this.desactivateAllHeader();
      document.querySelector(`#${this.hair}-header`).classList.add('isActive');
      this.displayHair = true;
    } else if (header === this.clothes) {
      this.desactivateAllHeader();
      document
        .querySelector(`#${this.clothes}-header`)
        .classList.add('isActive');
      this.displayClothes = true;
    } else if (header === this.face) {
      this.desactivateAllHeader();
      document.querySelector(`#${this.face}-header`).classList.add('isActive');
      this.displayFace = true;
    }
  }

  public desactivateAllHeader() {
    this.displaySkin = false;
    this.displayClothes = false;
    this.displayHair = false;
    this.displayFace = false;
    const elements = document.querySelectorAll('.avatar-header');
